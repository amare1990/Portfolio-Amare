...
const projects = [ 
  {
    ...
    title: 'Tonic 2',
    experiences: ['Canopy', 'Back End Dev', '2015'],
    featuredImage: './images/ictd4a-images/awesome-books-add.png',
    description: "A daily selection of privately personalized reads; no accounts or sign-ups required.",
    technologies: ['', 'html', 'css', 'javascript'],
    linkToLiveVersion: '',
    linkToSource: 'https://github.com/amare1990/AwesomeBooks'
...
function desktopVersion() {  
   ...
   projects[0].featuredImage = './images/ictd4a-images/awesome-books.png';
   projects[1].featuredImage = './images/ictd4a-images/desk-ictd4a.png';
